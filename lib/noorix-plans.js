 ...
 *
 * 8 Tiers:
 *   Lite     — Free       — 5/day, 9 features
 *   Glow     — Rs4,999    — 25/day, all 54 features
...
/* ═══════════════════════════════════════════════════════════
 * All 54 Noorix Features — unlocked at Glow tier and above
 * Cross-checked against:
 *   - NoorixChat.jsx FEATURES array (54 entries)
 *   - app/api/noorix/chat/route.js VALID_TYPES (54 entries)
 *   - lib/i18n.js noorix.feature.* labels (54 entries × 3 languages)
 *   - lib/noorix-ai.js FEATURE_MODEL_MAP (54 entries)
 * ═══════════════════════════════════════════════════════════ */
const ALL_FEATURES = [
...
/* ═══════════════════════════════════════════════════════════
 * Lite Tier — Free features (9 out of 54)
 * ═══════════════════════════════════════════════════════════ */
const LITE_FEATURES = [
  'skinIntelligence',
  'mealPhoto',
