...
const en = {
  ...
  kicker: '12 Rituals · Rose & Saffron · Crafted from Nature',
  heroSub:
  ...
  'badge.collagen': 'Botanical Heart',
  'badge.halal': 'Halal-Compliant Positioning',
  'badge.pakistan': 'Botanical by Nature',
  'collection.title': '12 NOORISH GOLD Glow Rituals',
  'collection.sub':
    'Tap a pouch to explore its jewel-toned profile. Every NOORIVA ritual shares the same secret NOORISH GOLD botanical heart to create one unmistakable NOORIVA undertone.',
  ...
  // ═══ HIGH PRIORITY (5) ═══
  'noorix.feature.stressCortisol': 'Stress & Cortisol',
  'noorix.feature.stressCortisolDesc': 'Track cortisol rhythms, mood signals, and burnout defense.',
  'noorix.feature.smoothMenopause': 'Smooth Menopause',
  'noorix.feature.smoothMenopauseDesc': 'Perimenopause cooling rituals, nutrition, and hormone skin advice.',
  'noorix.feature.brandAmbassador': 'Be Our Ambassador',
  'noorix.feature.brandAmbassadorDesc': 'Join the creator circle, unlock rewards, and share your glow.',
  'noorix.feature.noorivaClub': 'NOORIVA Club',
  'noorix.feature.noorivaClubDesc': 'Heart-to-heart circles, Lady of the Day spotlights, and community.',
  'noorix.feature.apiHub': 'API Hub',
  'noorix.feature.apiHubDesc': 'Live console of 20+ free APIs for nutrition, weather, and prayer times.',
  ...
  'scene.flavours': 'Shop',
  'scene.inside': 'Story',
  'scene.rituals': 'Moments',
  'scene.society': 'Offers',
  'scene.play': 'Play',
  'scene.voices': 'Family',
  'seo.homeTitle': 'NOORIVA — NOORISH GOLD Energy & Glow Drinks in Pakistan',
  'seo.homeDescription':
    'Discover NOORISH GOLD by NOORIVA — twelve natural skin-food rituals built on a golden botanical heart of saffron, rose, and mastic — clean hydration and honest radiance from nature. Halal-compliant. Drink your glow.',
  'seo.homeKeywords':
    'Noorish Gold, NOORIVA, NOORISH, drink your glow, natural energy drink, natural glow drink, botanical fresh drink, clean botanical drink, rose garden drink, saffron glow drink, mango botanical energy, berry natural glow drink, acai clarity drink, coconut moringa reset, dragon fruit hibiscus sheen, yuzu aloe barrier, bamboo silk reflect, pomegranate bloom drink, passionfruit luxe drink, best natural energy ritual, clean healthy drink, natural botanical energy, skin-food glow drink, natural wellness drink, botanical hydration drink, natural golden heart, rose hydrosol ritual, saffron glow benefits, mastic botanical drink, amla radiance drink, sea buckthorn glow drink, 150ml natural pouch ritual, premium botanical drink, luxury botanical ritual, natural drink rituals, natural glow ritual, beauty from nature',
};

/* ═══════════════════════════════════════════════════════════
   URDU (اردو) — Full localization including all 54 features
   ═══════════════════════════════════════════════════════════ */

const ur = {
  ...en,
  tagline: 'نوریوا · اپنا نور پئیں',
  kicker: '12 رسومات · گلاب و زعفران · فطرت سے مرصع',
  heroSub:
  ...
  'badge.collagen': 'بوٹانیکل ہارٹ',
  'badge.halal': 'حلال کمپلائنٹ پوزیشننگ',
  'badge.pakistan': 'پاکستان کے لیے',
  'collection.title': '12 نوریش گولڈ گلو رسومات',
  'collection.sub':
    'کسی پاؤچ کو چھوئیں۔ ہر NOORIVA ڈرنک ایک ہی پروڈکشن ریڈی NOORISH GOLD بوٹانیکل ہارٹ شیئر کرتا ہے۔',
  ...
  // ═══ HIGH PRIORITY (5) — Urdu ═══
  'noorix.feature.stressCortisol': 'اسٹریس اور کورٹیسول',
  'noorix.feature.stressCortisolDesc': 'کورٹیسول ردم، موڈ سگنلز اور برن آؤٹ دفاع ٹریک کریں۔',
  'noorix.feature.smoothMenopause': 'سموتھ مینوپاز',
  'noorix.feature.smoothMenopauseDesc': 'پیری مینوپاز کے لیے کولنگ رچولز اور ہارمون اسکن ایڈوائس۔',
  'noorix.feature.brandAmbassador': 'ہمارے سفیر بنیں',
  'noorix.feature.brandAmbassadorDesc': 'کرییٹر سرکل میں شامل ہوں اور انعامات انلاک کریں۔',
  'noorix.feature.noorivaClub': 'نوریوا کلب',
  'noorix.feature.noorivaClubDesc': 'دل سے دل کی بات، روزانہ اسپاٹ لائٹ اور کمیونٹی۔',
  'noorix.feature.apiHub': 'اے پی آئی ہب',
  'noorix.feature.apiHubDesc': 'نیوٹریشن، موسم اور نماز کے اوقات کے لیے لائیو کنسول۔',
  ...
  'seo.homeDescription':
    'NOORIVA کا NOORISH GOLD دریافت کریں: پروڈکشن ریڈی سائنچر ہیرو کمپلیکس جو ہر 150ml پاؤچ میں شامل کیا جاتا ہے۔ 12 پریفیومڈ گلو ڈرنکس اور انرجی رسومات۔',
  'seo.homeKeywords':
...
/* ═══════════════════════════════════════════════════════════
   ARABIC (العربية) — Full localization including all 54 features
   ═══════════════════════════════════════════════════════════ */

const ar = {
  ...en,
  tagline: 'نوريفا · اشرب إشراقتك',
  kicker: '12 طقوس · ورد وزعفران · مصنوع من الطبيعة',
  heroSub:
  ...
  'badge.collagen': 'قلب نباتي',
  'badge.halal': 'تموضع متوافق مع الحلال',
  'badge.pakistan': 'مصمم لباكستان',
  'collection.title': '12 طقس إشراق من نوريش غولد',
  'collection.sub':
    'المس كيسًا لاستكشاف كل طقس. كل طقس من NOORIVA يشترك في قاعدة نوريش غولد النباتية المميزة.',
  ...
  // ═══ HIGH PRIORITY (5) — Arabic ═══
  'noorix.feature.stressCortisol': 'التوتر والكورتيزول',
  'noorix.feature.stressCortisolDesc': 'تتبع إيقاع الكورتيزول وإشارات المزاج والوقاية من الإرهاق.',
  'noorix.feature.smoothMenopause': 'سن اليأس السلس',
  'noorix.feature.smoothMenopauseDesc': 'طقوس تبريد وتغذية ونصائح للبشرة خلال فترة انقطاع الطمث.',
  'noorix.feature.brandAmbassador': 'كن سفيرنا',
  'noorix.feature.brandAmbassadorDesc': 'انضم إلى دائرة صناع المحتوى وافتح المكافآت الحصرية.',
  'noorix.feature.noorivaClub': 'نادي نوريوا',
  'noorix.feature.noorivaClubDesc': 'حلقات تواصل من القلب إلى القلب وإضاءات يومية.',
  'noorix.feature.apiHub': 'مركز الواجهات البرمجية',
  'noorix.feature.apiHubDesc': 'لوحة تحكم حية للتغذية والطقس وأوقات الصلاة.',
  ...
  'seo.homeDescription':
    'اكتشف نوريش غولد من NOORIVA: قاعدة أساسية نباتية مميزة لكل كيس 150 مل. 12 طقسًا فاخرًا للإشراق والطاقة والترطيب في باكستان.',
  'seo.homeKeywords':
...
export function translate(language, key, params) {
  ...
  if (value === undefined) {
    if (key.startsWith('noorix.feature.')) {
      const raw = key.replace('noorix.feature.', '').replace('Desc', '');
