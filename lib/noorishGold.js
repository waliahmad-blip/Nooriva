...
export const FINAL_VERDICT = {
  title: "Final Verdict",
  description:
    "This is the definitive, production-ready NOORISH GOLD golden botanical heart. It delivers botanical aroma, naturally layered, smooth, natural sweetness, explicit radiance positioning, and natural stability without compromising clarity, taste, or regulatory compliance. Every NOORIVA SKU shares this exact base, ensuring instant brand recognition while allowing each active layer to shine through its own jewel-toned profile.",
