...
export default function CheckoutOverlay() {
  ...
  return (
    <AnimatePresence>
      {checkoutOpen && (
        <div
          className="fixed inset-0 z-[70] overflow-y-auto p-3 md:p-4"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <motion.div
            ...
            className="glass relative mx-auto my-6 w-full max-w-2xl rounded-[2rem] bg-white/90 p-5 md:p-8"
          >
            {/* Header */}
            <div className="flex items-center justify-between">
              <h3 className="display-heading text-2xl md:text-3xl">{t("checkout.title")}</h3>
              <button
                ref={closeRef}
                onClick={reset}
            ...
            <div className="mt-6 grid grid-cols-4 gap-2">
              {stages.map((label, i) => (
                <div key={label} className="text-center">
                  <div
                    className={`mx-auto grid h-8 w-8 place-items-center rounded-full text-xs font-bold transition ${
                ...
                {stage === 1 && (
                  <div className="mt-6 space-y-3">
                    <button
                      ...
                      className={`tap-target w-full rounded-[1.5rem] border-2 p-5 text-left transition ${
